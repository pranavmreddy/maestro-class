...
def asking(url, device, group_name="Alice"):
    data = {"Application_Name": "Project_Attack", "data_type": "test", "student_name": group_name,"task": "attack_project"}
...
def getScore(url, device, group_name):
    data = {"Application_Name": "Project_Attack", "data_type": "test", "student_name": group_name, "task": "attack_project"}
